        ...
        <div id="block2">
            ...
            <div class="question">
                ...
                <h4><input type="radio" name="isRaisingAlone" value="false"
                           title="Являетесь ли Вы вдовой (вдовцом), одиноким родителем, приемным родителем, опекуном или попечителем">&emsp;нет
                </h4>
                <input type="radio" name="isRaisingAlone" value="null" hidden title="">
            </div>
            <div class="question">
